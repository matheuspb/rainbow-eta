This folder contains the c-code of our Reference implementation of
Rainbow(GF(16),56,48,48)
...
sign.c            -- Wrapper to reduce the API to the core functions of rainbow

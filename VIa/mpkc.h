...
static inline void mpkc_pub_map_gf16_n_m(
...
static inline void mpkc_interpolate_gf16(
	...
	for (unsigned i = 0; i < n_var; i++) {
		...
		memcpy(
			poly + _PUB_M_BYTE * (n_var + IDX_QTERMS_REVLEX(i, i)), tmp_r2,
			_PUB_M_BYTE);
	}
